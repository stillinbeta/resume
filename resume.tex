...
\vbar
\head{Experience}
    \company{Pagerduty}{April 2023 to February 2026}
        ...
        \begin{employment}
          ...
          \item Lead team on internal Kubernetes migration
          \item Participated in oncall rotation for high impact services in an
            SLA-driven environment
          \item Ran multiple internal workshops on Kubernetes and Istio
          \end{employment}
          ...
          \item Tech lead and primary maintainer for ingress pipeline with 1000s of requests per second of HTML traffic
          \end{employment}
          ...
          \item Participated in 24/7 oncall rotation for high-impact services with sub-5 minute response SLAs.
          ...
          \company{den-tv}
          \companydesc{A display of useful information that runs in our kitchen}
          \begin{employment}
          \item A combination of Yew and Actix and for an all-Rust home dashboard
          \item \url{https://blog.stillinbeta.com/2024-01-01-overengineered-household-display.html}
          \item \url{https://git.sr.ht/~liz/den-tv}
          \end{employment}
          % \company{is31fl3741}
...
\head{Talks}
      ...
      \company{Service Messy: Pagerduty's Service Mesh Migration}{October 2025}
      \companydesc{The trials and tribulations of Pagerduty's migration to Istio}
      \begin{employment}
          \item Given at SRECon EMEA 2025
          \item Recording: \url{https://bit.ly/liz-talk8}
          \item Slides: \url{https://bit.ly/liz-slides8}
      \end{employment}

      \company{Keyboardin’ Ain’t Easy??? How to not build a keyboard!!!}{August 2024}
      \companydesc{A detailed account of all the ways I failed to build my own keyboard}
      \begin{employment}
          \item Given at the final !!con
          \item Recording: \url{https://bit.ly/liz-talk7}
          \item Slides: \url{https://bit.ly/liz-slides7}
      \end{employment}
